...
{
    public class Demo4DbMigrationService : ITransientDependency
    {
        public ILogger<Demo4DbMigrationService> Logger { get; set; }
        ...
        public Demo4DbMigrationService(
            ...
            IEnumerable<IDemo4DbSchemaMigrator> dbSchemaMigrators)
        {
            ...
            Logger = NullLogger<Demo4DbMigrationService>.Instance;
        }
